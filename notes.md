...
Aub agar humae 1 functional component ko kisi dusrae component kae andar pass karna hota hai toh hum use karte hai,angle brackets kae anadr component name pass karte jisae humae dusrae component kae andar pass karna hai . Aur is process ko hum bolte hai "component composition" .
...
**2️⃣ useEffect( ) :** This hook is again a function which takes two arguments inside it. The first argument is callback function and the second argument is dependency array. But before using this hook we need to import this hook from react.
...
Yani ki aub jitni baar hum search text mae kuch bhi enter karenge toh hamara component baar-baar re-render karega.
